...
public class Floyds {
    ...
    public static void main(String[] args) {
        ...
        // Enter the cost matrix, 0 for principle diagnol axis and no direct edge
        // (all source shortest path, source to source is zero)
        // Make 999 for no direct edge from i to j
